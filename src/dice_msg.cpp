...
namespace dice::msg {
    ...
    const std::map<std::string, std::string> global_msg {
        {"strRollDice", "{nick} 投掷 {reason}: {dice_expression}"},
            ...
            {"strRollHiddenDiceWithJudge",
             "在{origin}中 {nick} 投掷 {reason}: {dice_expression}/{judge_value} {success_indicator}"},
            {"strInvalidDiceError", "错误: 不合法的掷骰表达式"}, {"strNicknameError", "内部错误: 无法获取昵称"},
            ...
            {"strNickSetWithCardChange",
             "已将{old_nick}的{is_global}昵称修改为{new_nick}, 并将{origin}中的人物卡绑定到\"{new_nick}\""},
            {"strNickEmpty", "已将{old_nick}的{is_global}昵称删除"},
            {"strSetHelpEnabled", "已启用本群/讨论组的Help功能"}, {"strSetHelpDisabled", "已禁用本群/讨论组的Help功能"},
            {"strSetJrrpEnabled", "已启用本群/讨论组的Jrrp功能"}, {"strSetJrrpDisabled", "已禁用本群/讨论组的Jrrp功能"},
            ...
            {"strStList", "{nick}的全部可用人物卡如下:\n{card_names}"}, {"strStProperty", "{property}: {value}"},
            ...
            {"strPropertyInvalidError", "错误: 输入的属性或属性值无效"},
            {"strStSwitch", "已成功切换到人物卡\"{card_name}\""},
            {"strUnknownError", "错误: 未知错误"},
            {"strFumble", "大失败"},
            {"strFailure", "失败"},
            {"strSuccess", "成功"},
            {"strHardSuccess", "困难成功"},
...
const std::map<std::string, std::vector<std::string>> default_deck{
    ...
    {"amgc专精", {"1特异",  "2火焰",  "3空气",  "4灵魂",  "5强化",  "6心灵",  "7时间",  "8雷电",  "9声波",  "10黑暗",
